...
public class TopTrackListAdapter extends ArrayAdapter<TopTracks> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.title.setText(Playlist.topTracks.get(position).getTopTrackName());
        holder.artist.setText(Playlist.topTracks.get(position).getArtist());
        Picasso.with(mContext).load(Playlist.topTracks.
